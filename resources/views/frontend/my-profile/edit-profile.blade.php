                        ...
                        <div class="profileAndName flex items-center gap-5">
                            ...
                            <div class="profileImg rounded-full relative">
                               ...
                               <!-- Hidden File Input - placed right after the label that references it -->
                                ...
                                <label for="profileImageInput" class="absolute bottom-2 right-2 cursor-pointer bg-white p-1 rounded-full shadow-md">
                                    <img src="{{ asset('frontend/assets/images/editIcon.svg') }}" alt="Edit" class="w-5 h-5">
                                </label>
                            </div>
                        ...
                        <div class="profileInfo flex flex-col gap-3">
                            ...
                            <div class="flex w-full gap-10">
                                ...
                                <div class="flex flex-col w-1/2 gap-1">
                                    ...
                                    <input type="text" name="phone_number" id="phoneNumber" value="{{ $user->phone_number ?? '' }}"
                                        class="border border-gray-300 bg-[#F4F4F4] rounded-2xl p-[16px] focus:outline-none focus:ring-2 focus:ring-purple-500">
                                </div>
                            </div>
                            ...
                            <div class="flex w-full gap-10">
                                <div class="flex flex-col w-1/2 gap-1">
                                    ...
                                    <input type="text" name="company_name" id="companyName" value="{{ $user->company_name ?? '' }}"
                                        class="border border-gray-300 bg-[#F4F4F4] rounded-2xl p-[16px] focus:outline-none focus:ring-2 focus:ring-purple-500">
                                </div>
                                <div class="flex flex-col w-1/2 gap-1">
                            ...
                            <div class="buttonsDiv flex justify-end font-bold items-center gap-5 mt-5">
                                <div class="button w-[150px] bg-gray-100 flex justify-center items-center rounded-2xl px-6 py-4 text-[#000000]">
                                    Cancel
                                </div>
                                <button type="submit" class="button p-6 bg-[#54114C] text-[#ffffff] w-[150px] flex justify-center items-center rounded-2xl px-6 py-4">
                                    Save
                                </button>
                            </div>
                        </div>
