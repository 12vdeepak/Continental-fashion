    ...
    <div class=" mt-4  rounded-lg ">
            ...
            <div class="address bg-[#F4F4F4] flex p-4 gap-5 rounded-lg">
                ...
                <div class="info w-full">
                    <div class="nameAndDef flex gap-3 items-center w-full ">
                        <div class="nameAndChange flex items-center justify-between text-[20px] font-medium w-full ">
                            <div class="name">
      
                                Kishore MS
                            </div>
                            <a href="/pages/selectAddress.html">
      ...
      <div class="mt-6 bg-[#F4F4F4] p-4 lg:p-8 rounded-xl grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div class="text-right sm:text-left">
              ...
              <button id="placeOrderBtn" class="mt-10 bg-[#54114C] text-white px-6 py-2 rounded-lg w-full">Place Order</button>
          </div>
      </div>
  </div>
   <!-- Order Success Popup (Initially Hidden) -->
<!-- Order Success Popup (Initially Hidden) -->
<div id="orderSuccessPopup" class="fixed inset-0 bg-opacity-30 backdrop-blur-sm flex items-center justify-center z-50 hidden ">
    <div id="popupContent" class="bg-white rounded-xl shadow-lg w-[500px] p-6 relative">
        <!-- Close Button -->
        <button id="closePopupBtn" class="absolute top-3 right-3 text-gray-600 hover:text-gray-900 text-2xl font-bold">&times;</button>

        <!-- Success Icon -->
        <div class="flex justify-center">
            <div class="bg-[#2AD15640] text-white rounded-full p-3 ">
                <img src="{{ asset('frontend/assets/images/success-svgrepo-com (1).svg')}}" alt="" class="w-[80px] h-[80px]" >
            </div>
        </div>
            ...
            <div class="flex items-center bg-gray-100 p-4 rounded-lg">
                ...
                <div class="ml-4">
                    ...
                    <div class="text-gray-600 text-sm flex gap-2 mt-1">
                        <span>Gender: ♂️</span> |
                        <span>Color: <span class="w-3 h-3 inline-block rounded-full bg-[#54114C]"></span></span> |
                        <span>Size: XXL</span> |
                        <span>Qty: 120</span>
                    </div>
                    <div class="mt-2 text-sm flex gap-4">
                        <span class="text-gray-600">Unit Price: <span class="font-semibold">$12</span></span>
                        <span class="text-gray-600">Total Price: <span class="font-semibold text-blue-600">$126</span></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mt-6 text-center">
            <button id="closePopup" class="bg-[#54114C] text-white px-6 py-3 rounded-lg text-lg w-full">Continue Shopping</button>
        </div>
    </div>
</div>
