                ...
                <form action="{{ route('cancellation-policy.update', ['cancellation_policy' => $cancellation_policy]) }}"
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <textarea id="summernote_cancellationPolicy" type="text" rows=5 name="description"
                                class="form-control @error('description') is-invalid @enderror" placeholder="Description">{{ $cancellation_policy->description }}</textarea>
                            @error('description')
